            ...
            return (
                <aside className={cx("guide__content")}>
                    ...
                    <h2 className={cx("guide-step-heading")} data-aos="fade-down">
                        DEMARKET is developed based on Cardano, an ecosystem with a series of
                        outstanding advantages compared to other Blockchain platforms, helping users
                        to be assured of security, personal information will never be compromised.
        ...
        Children: function () {
            return (
                <aside className={cx("guide__content")}>
                    ...
                    <h2 className={cx("guide-step-heading")} data-aos="fade-down">
                        To buy, mint or manage NFTs on DEMARKET, you&apos;ll first need to connect
                        your wallet. You can do so in just a few easy steps!
                    </h2>
                    <div>
            ...
            return (
                <aside className={cx("guide__content")}>
                    ...
                    <h2 className={cx("guide-step-heading")}>
                        Minting an NFT on DEMARKET is a straightforward process. Follow these
                        detailed steps to create and list your NFT on the platform:
                    </h2>
    ...
    },
    {
        ...
        Children: function () {
            return (
                <aside className={cx("guide__content")}>
                    <h2 className={cx("guide-step-heading")}>
                        Smart contracts are executed on blockchain, which means that the terms are
                        stored in a distributed database and cannot be changed. Transactions are
                        also processed on the blockchain, which automates payments and
                        counterparties.
                    </h2>
