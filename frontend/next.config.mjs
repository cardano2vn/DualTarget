const nextConfig = {
    env: {
        ...
        EXCHANGE_ADDRESS_FREE_MAINNET: "ecc575c43fe93b158e02a176c9159afe681cd097910748fde50d33a7",
        POOL_ID_MAINNET: "pool1rqgf6qd0p3wyf9dxf2w7qcddvgg4vu56l35ez2xqemhqun2gn7y",
        DJED_TOKEN_ASSET_MAINNET: "e16c2dc8ae937e8d3790c7fd7168d7b994621ba14ca11415f39fed724d494e",
        DUALTARGET_TXHASH_REFRENCE_SCRIPT_MAINNET:
            "053f411b37ff582d4fa3f69f804b5199cabc90eac977d5acaacf1b59babe2e31",
        CEXPLORER_RPC_URL_MAINNET: "https://cexplorer.io",
        // PREPROD NETWORK
        BLOCKFROST_NETWORK_NAME_PREPROD: "Preprod",
        BLOCKFROST_RPC_URL_PREPROD: "https://cardano-preprod.blockfrost.io/api/v0",
        BLOCKFROST_PROJECT_API_KEY_PREPROD: "preprodu5jsJkZTsUmgftePQWiTSmgxJiNhYiZj",
        ...
        DJED_TOKEN_ASSET_PREPROD: "e16c2dc8ae937e8d3790c7fd7168d7b994621ba14ca11415f39fed724d494e",
        DUALTARGET_TXHASH_REFRENCE_SCRIPT_PREPROD:
            "053f411b37ff582d4fa3f69f804b5199cabc90eac977d5acaacf1b59babe2e31",
        CEXPLORER_RPC_URL_PREPROD: "https://preprod.cexplorer.io",
